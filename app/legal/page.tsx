...
export const metadata = {
  ...
  description: "솔로위키의 저작권·커뮤니티 운영 원칙. fan archive 정당성, fair use 가이드, 정보 정정 요청.",
};
      ...
      <div className="max-w-2xl mx-auto px-6">
        ...
        <div className="space-y-6 text-ink-soft leading-relaxed">
          ...
          <section>
            ...
            <p>
              솔로위키는 특정 방송 프로그램과 제휴하지 않은 <strong>비공인 팬덤 정보 도감</strong>이에요.
              모든 출연자 정보는 팬이 직접 큐레이션한 것이며, 공식 자료가 아닙니다.
              1기부터 33기까지 408명의 출연자 프로필·커플·하이라이트를 한 곳에 모았어요.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-3">
              솔로위키는 한국 저작권법 및 국제 fair use (공정 이용) 원칙을 준수합니다.
            </p>
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <strong>방송 화면·스틸컷·공식 로고는 일절 사용하지 않습니다.</strong>
              </li>
              <li>
                <strong>YouTube 영상은 클릭 시 YouTube로 이동</strong>하여 재생합니다.
                솔로위키는 영상을 호스팅하지 않으며, YouTube가 공식 제공하는 thumbnail URL만 사용합니다.
              </li>
              <li>
                모든 thumbnail 하단에는 <strong>출처 채널(© ENA, © SBS Plus 등)</strong>을 명시합니다.
                시청자가 클릭하면 YouTube의 원본 페이지로 이동해, 원작자의 조회수·수익에 기여합니다.
              </li>
              <li>
                출연자 사진은 본 사이트에서 자체 제작한 이니셜 + 그라데이션 아바타로만 표시합니다.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              솔로위키는 현재 비상업적으로 운영됩니다. 추후 광고·제휴가 붙더라도
          ...
          <section className="pt-4 border-t border-line">
            <p className="text-muted text-[12.5px]">
              ...
              contact@salowiki.com (placeholder)
            </p>
          </section>
        </div>
      </div>
